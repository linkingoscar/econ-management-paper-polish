...
REQUIRED_FILES = (
    ...
    "assets/method-language-report.schema.json",
    "assets/meaning-audit.schema.json",
    ...
    "scripts/check_method_language.py",
    "scripts/meaning_audit.py",
    ...
    "scripts/ai_review_contract.py",
    "scripts/build_ai_review_packet.py",
    "scripts/run_ai_reviews.py",
